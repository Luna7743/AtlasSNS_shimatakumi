...
class UsersController extends Controller
{
    ...
    public function followlist()
    {
        ...
        $posts = Auth::user()->follows()->with('posts')->get()->pluck('posts')->flatten();
...
public function followers()
{
    ...
    // 自分をフォローしているユーザーの投稿を取得
    $posts = Auth::user()->followers()->with('posts')->get()->pluck('posts')->flatten();
...
public function update(Request $request)
{
    ...
    //画像ファイルをアップロードして保存する
   if ($request->hasFile('image')) { //←リクエストに画像ファイルが含まれているかを確認
